...
function PasswordChangeCard() {
  ...
  return (
    <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 space-y-4 max-w-xl">
      <div className="space-y-1">
        <h2 className="text-lg font-serif font-semibold text-amber-100">Admin Account Security</h2>
        <p className="text-xs text-slate-400">Update your administrator account password.</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-3">
        <div>
          ...
          <input
            ...
            className="w-full px-3 py-2 rounded-xl bg-slate-800 border border-slate-700 text-sm text-slate-100 focus:outline-none focus:border-amber-400"
            placeholder="••••••••"
          />
        </div>
        ...
        <button
          type="submit"
          disabled={loading}
          className="px-4 py-2 rounded-xl bg-amber-500 hover:bg-amber-400 text-slate-950 font-medium text-xs transition disabled:opacity-50"
        >
